...
public class Slf4jSpyLogDelegator implements SpyLogDelegator
{
   ...
   * Create a SpyLogDelegator specific to the Simple Logging Facade for Java (slf4j).
    ...
    private final WLLogger jdbcLogger = new WLLogger("jdbc.audit");
    ...
    private final WLLogger resultSetLogger = new WLLogger("jdbc.resultset");
    ...
    private final WLLogger resultSetTableLogger = new WLLogger("jdbc.resultsettable");
    
    /**
     * Logger that shows only the SQL that is occuring
     */
    //private final Logger sqlOnlyLogger = LoggerFactory.getLogger("jdbc.sqlonly");
    private final WLLogger sqlOnlyLogger = new WLLogger("jdbc.sqlonly");

    //public Logger getSqlOnlyLogger()
    public WLLogger getSqlOnlyLogger()
    {
    ...
    private final WLLogger sqlTimingLogger = new WLLogger("jdbc.sqltiming");
    ...
    private final WLLogger connectionLogger = new WLLogger("jdbc.connection");
    ...
    private final WLLogger debugLogger = new WLLogger("log4jdbc.debug");
    ...
    {
        String classType = spy.getClassType();
        /*Logger*/WLLogger logger = ResultSetSpy.classTypeDescription.equals(classType) ? 
